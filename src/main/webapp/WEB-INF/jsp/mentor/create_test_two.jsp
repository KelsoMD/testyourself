                        ...
                        <c:forEach items="${recentTestQuestions}" var="recentQuestion">
                            ...
                            <tr>
                                ...
                                <td class="body-item mbr-fonts-style display-7">
                                    ...
                                    <%--</form>--%>
                                    <a href="<c:url
                                    value="/mentor/tests/build/delete?question_id=${recentQuestion.getId()}"/>"
                                            class="btn btn-black-outline display-4"><spring:message code="delete"/></a>
                                    <a
                                        target="_blank"
                                        href="<c:url value="/mentor/tests/build/${recentQuestion.getId()}"/>"
                            ...
                            <td class="body-item mbr-fonts-style display-7">
                                ...
                                <%--<form action="add" method="get">--%>
                                    ...
                                    <%--<button type="submit"--%>
                                            ...
                                            <%--code="add"/></button>--%>
                                <%--</form>--%>
                                <a href="<c:url value="/mentor/tests/build/add?question_id=${question.getId()}"/>"
                                        class="btn btn-black-outline display-4"><spring:message code="add"/></a>
                                    <a
                                            target="_blank"
                                            href="<c:url value="/mentor/tests/build/${question.getId()}"/>"
                                            class="btn btn-black-outline display-4"><spring:message code="preview"/></a>
                            </td>
                        </tr>
                        </tbody>
