    ...
    <div class="container container-table">
        <h3
            ...
            <div class="mbr-section-btn text-center pt-4">
                <form action="groups/create_page" method="get">
                    <button type="submit"
                            class="btn btn-sm btn-black-outline display-4">Создать группу
                    </button>
                </form>
            </div>
        </h3>
                    ...
                    <c:forEach items="${groups}" var="item">
                        ...
                        <tr>
                            ...
                            <td class="body-item mbr-fonts-style display-7"><a
                                    ...
                                    href="<c:url value="/mentor/groups/${item.getId()}"/>"><spring:message
                                    code="group_menu"/>
                            </a></td>
                        </tr>
                        </tbody>
