                ...
                <div class="plan col-12 mx-2 my-2 justify-content-center col-lg-3">
                    <div class="plan-header text-center pt-5">
                        <h3 class="plan-title mbr-fonts-style display-5">
                            <spring:message
                                    code="task.result"/><br> ${item.getGroup().getTitle()}
                        </h3>
                        <div class="plan-price">
                            <h3 class="plan-title mbr-fonts-style display-5">Че-т еще</h3>
                        ...
                        <div class="plan-list align-center">
                            <ul
                                ...
                                <li class="list-group-item"><spring:message
                                        code="theme"/></li>
                                <li class="list-group-item">${item.getGroup().getTheme()}</li>
            ...
            <c:forEach items="${tests}" var="item">
                <div class="plan col-12 mx-2 my-2 justify-content-center col-lg-3">
                    <div class="plan-header text-center pt-5">
                        <h3 class="plan-title mbr-fonts-style display-5">
                            <spring:message
                                    code="test_id"/><br> ${item.getId()}
                        </h3>
                        <div class="plan-price">
                            <h3 class="plan-title mbr-fonts-style display-5"><spring:message
                                    code="question_size"/></h3>
                            <span class="price-figure mbr-fonts-style display-1">
                    ...
                    <div class="plan-body pb-5">
                        ...
                        <div class="mbr-section-btn text-center pt-4">
                            <a class="btn btn-sm btn-black-outline display-4"
                               href="<c:url value="/mentor/tests/${item.getId()}"/>"><spring:message
                                    code="start_test"/>
                            </a>
                        </div>
                    </div>
