        ...
        <h3
            ...
            <div class="mbr-section-btn text-center pt-4">
                <a class="btn btn-sm btn-black-outline display-4"
                   href="<c:url value="/mentor/tests/create"/>"> <spring:message
                        code="create_test"/>
                </a> <a class="btn btn-sm btn-black-outline display-4"
                        href="<c:url value="/mentor/tests/create_question"/>"><spring:message
                    code="create_question"/> </a> <a
                    class="btn btn-sm btn-black-outline display-4"
                    href="<c:url value="/mentor/tests/create_theme"/>"> <spring:message
                    code="create_theme"/>
            </a>
            </div>
        </h3>
        <div class="table-wrapper">
            <div class="container">
                <div class="row search">
                    ...
                    <div class="col-md-6">
                        <form action="<c:url value="/mentor/tests/search_test"/>" method="get">
                    ...
                    <c:forEach items="${tests}" var="test">
                        ...
                        <tr>
                            ...
                            <td class="body-item mbr-fonts-style display-7"><a
                                    class="btn btn-sm btn-black-outline display-4"
                                    href="<c:url value="/mentor/tests/${test.getId()}"/>"><spring:message
                                    code="start_test"/>
                            </a></td>
                        </tr>
                        </tbody>
